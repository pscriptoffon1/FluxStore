            ...
            <div className="page">
                ...
                <div className="p-3">
                    ...
                    <div className="row icon-three">
                        <div className="col-1">  <i class="fa-solid fa-location-dot c-ic-11"></i></div>
                        <div className="col-3">
                        ...
                        <div className="col-1">
                            <i class="fa-solid fa-credit-card c-ic-22"></i>
                        </div>
                        <div className="col-3">
                            <svg width="63" height="2" viewBox="0 0 63 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1H62" stroke="#C8C7CC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1 15" />
                        ...
                        <div className="col-1">
                            <i class="fa-solid fa-check c-ic-33"></i>
                    ...
                    <div className="row position-sh">
                        <small className="step-text">STEP 2</small>
                        <b><big><big>Payment</big></big></b><br />
                        <div className="text-step-1">
                            ...
                            <div className="payment-method">
                                ...
                                <div className="payment-card active">
                                    ...
                                    <span className="payment-label white">Credit Card</span>
                                </div>
                        ...
                        <div className="card-header">
                            <h3 className="card-title">Choose your card</h3><br /><br />
                            <a href="/addnew">
                        ...
                        <div className="checkout-panel">
                            <div className="summary-list">
                                ...
                                <div className="summary-row">
                                    ...
                                    <span className="value">CODE123</span>
                                </div>
                           ...
                           <a href="/check3"><button className="order-btn">
                                Place my order
                            </button></a> 
                        </div>
                    </div>
