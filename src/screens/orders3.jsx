                ...
                <div className="p-3">
                    ...
                    <div class="orders-page">
                        ...
                        <div class="order-tabs">
                            ...
                            <a href="/orders2"><button class="tab active2">Delivered</button></a>
                            <a href="/orders3"><button class="tab active">Cancelled</button></a>
                        </div>
                        <br />
                        <div class="orders-list">
                            ...
                            <div class="order-card">
                                ...
                                <div class="order-footer">
                                    <span class="status pending2">CANCELED</span>
